...
func (vs *ViewServer) tick() {
	...
	if vs.primary != "" {
		...
		if pingTime.Before(vs.preTime) { //primary reboot or crash
			log.Printf("the primary is crash" + vs.primary)
